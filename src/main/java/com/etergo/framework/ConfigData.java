...
public class ConfigData {
    ...
    public static String getPathToApp() {
        String pathToApp = getPropertyAndFailIfMissing("path.to.app");
        return pathToApp.contains("/Users/") ? pathToApp : System.getProperty("user.dir") + pathToApp;
    }
    ...
    public static String getDeviceBundleId() {
        return getPropertyAndFailIfMissing("app.bundleid");
    }
